...
\begin{itemize}
    \item \textbf{Tool:} NotebookLM \begin{itemize}
        \item \textbf{Purpose:} \emph{Help in understanding collected research material}.
        \item \textbf{Prompts / scope:} \emph{Prompts here were extensive and covered multiple topics. Full excerpt can be shared}.
    \end{itemize}
    \item 
