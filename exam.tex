...
\author{Your Name \\ Student ID: \texttt{1234567} \\ \texttt{your.email@student.tue.nl}}
\date{\today}
...
\input{questions/q1_lecture2_reification}
\input{questions/q2_lecture3_mpg_rdf}
\input{questions/q3_lecture8_rdf_to_mpg_mapping}
...
AI tools were used only for the following purposes:

\begin{itemize}
    \item \textbf{Tool:} \emph{<e.g. ChatGPT-5 / Claude / none>}.
    \item \textbf{Purpose:} \emph{<e.g. polishing prose, grammar suggestions, none>}.
    \item \textbf{Prompts / scope:} \emph{<brief, honest description>}.
\end{itemize}
